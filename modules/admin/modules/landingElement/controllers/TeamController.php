...
use app\modules\admin\modules\landingElement\forms\TeamForm;
use app\modules\admin\modules\landingElement\models\LandingElement;
use app\modules\admin\modules\landingElement\search\TeamSearch;
use Exception;
...
class TeamController extends BaseController
{
    ...
    public function getModel($id)
    {
        ...
        if (!$model) {
            throw new Exception(translate("Team not found"));
        }
        return $model;
    }
}