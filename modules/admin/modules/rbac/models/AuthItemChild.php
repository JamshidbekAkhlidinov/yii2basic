...
class AuthItemChild extends \yii\db\ActiveRecord
{
    ...
    /**
     * {@inheritdoc}
     * @return \app\modules\admin\modules\rbac\query\AuthItemChildQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\modules\rbac\query\AuthItemChildQuery(get_called_class());
    }
}
